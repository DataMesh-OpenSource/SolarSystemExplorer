...
|    **Mainboard**     |       Support M.2 SSD or PCI-E SSD       | <ul><li>Note that if you choose to use internal capture card the mainboard **must have** one extra PCI-E x16 slot for capture card.</li></ul> |
...
|   **Capture Card**   |         PCI-E Video Capture Card         | <ul><li>Recommend [Blackmagic Intensity Pro 4K](https://www.blackmagicdesign.com/products/intensitypro4k).</li><li> Other types of tested cards include: [Blackmagic UltraStudio for Thunderbolt Card](https://www.blackmagicdesign.com/products/ultrastudio) and [Blackmagic Intensity Shuttle Card](https://www.blackmagicdesign.com/products/intensity).</li><li>Note that only Blackmagic Intensity Pro 4K card is heavily tested and fully compatible. You may need additional settings and encounter problems using other capture cards.</li></ul> |
